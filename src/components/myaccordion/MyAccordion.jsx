    ...
    <Container>
        ...
        <Accordion defaultActiveKey="0">
            <Accordion.Item eventKey="0">
                <Accordion.Header><h4>Dúvidas 1</h4></Accordion.Header>
                <Accordion.Body>
                <p>
            ...
            <Accordion.Item eventKey="1">
                <Accordion.Header><h4>Dúvidas 2</h4></Accordion.Header>
                <Accordion.Body>
                    <p>
            ...
            <Accordion.Item eventKey="2">
                <Accordion.Header><h4>Dúvidas 3</h4></Accordion.Header>
                <Accordion.Body>
                    <p>
            ...
            <Accordion.Item eventKey="3">
                <Accordion.Header><h4>Dúvidas 4</h4></Accordion.Header>
                <Accordion.Body>
                    <p>
